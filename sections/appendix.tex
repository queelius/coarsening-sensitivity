...
the reading that the singleton-budget interpretation, and the weak-supervision
instance, intend.
...
between the two hypotheses. By Le Cam's two-point method
\citep{tsybakov2009introduction} any estimator incurs
...
information about another, so the budgets add (Assouad's lemma over the $r$
confounded directions): $n_{\mathrm{s}} = \Omega(r \sigma^2 /
