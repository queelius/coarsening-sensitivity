...
bound \citep{manski1989anatomy} in the modern partial-identification sense
\citep{tamer2010partial}, and the impossibility of testing $\delta$ from the
...
\citet{neweypowell2003instrumental}, the single-view specialization of the
proxy-identification logic of \citet{miao2018identifying}, and the rank gap in the
coarse-label information-preservation condition of \citet{fotakis2021efficient}; the
singleton is the substitute for the multiple conditionally independent views that the
latent-variable canon assumes and the coarsened-data setting lacks.
