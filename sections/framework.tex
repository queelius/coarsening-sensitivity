...
$\sup_{y \in c(r)} |h(r,y)| \le 1$ and within-set mean zero under the fitted
weighting, such that
\begin{equation}
...
preference for some admissible latent values over others, and the factorization
that licenses \eqref{eq:facevalue} no longer holds exactly. The magnitude $\delta$
